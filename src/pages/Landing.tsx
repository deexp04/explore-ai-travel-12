            ...
            <div className="relative">
              <div className="relative w-full h-96 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-24 h-24 bg-gradient-to-r from-gray-700 to-gray-600 rounded-2xl flex items-center justify-center shadow-2xl">
                    <MessageSquare className="w-12 h-12 text-white" />
                  </div>
                </div>

                {/* Floating elements */}
                <div className="absolute top-4 left-8 w-16 h-16 bg-gray-800 rounded-full flex items-center justify-center animate-bounce">
                  <Target className="w-8 h-8 text-green-400" />
                </div>
                <div className="absolute top-12 right-8 w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center animate-pulse">
                  <Globe className="w-6 h-6 text-orange-400" />
                </div>
                <div className="absolute bottom-8 left-12 w-14 h-14 bg-gray-800 rounded-xl flex items-center justify-center animate-bounce delay-150">
                  <Rocket className="w-7 h-7 text-purple-400" />
                </div>
                <div className="absolute bottom-12 right-16 w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center animate-pulse delay-300">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              <Card key={index} className="border border-gray-800 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 bg-gray-900 backdrop-blur-sm group">
